...
public final class SettingsViewModel_Factory implements Factory<SettingsViewModel> {
  ...
  public SettingsViewModel_Factory(Provider<SettingsPreferences> settingsPreferencesProvider,
      Provider<BackupRepository> backupRepositoryProvider, Provider<Context> contextProvider) {
  ...
  public SettingsViewModel get() {
    return newInstance(settingsPreferencesProvider.get(), backupRepositoryProvider.get(), contextProvider.get());
  }

  public static SettingsViewModel_Factory create(
      Provider<SettingsPreferences> settingsPreferencesProvider,
      Provider<BackupRepository> backupRepositoryProvider, Provider<Context> contextProvider) {
    return new SettingsViewModel_Factory(settingsPreferencesProvider, backupRepositoryProvider, contextProvider);
  }

  public static SettingsViewModel newInstance(SettingsPreferences settingsPreferences,
      BackupRepository backupRepository, Context context) {
    return new SettingsViewModel(settingsPreferences, backupRepository, context);
  }
}
