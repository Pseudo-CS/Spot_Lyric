  ...
  public SongLyricsDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSongLyricsEntity = new EntityInsertionAdapter<SongLyricsEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `song_lyrics` (`id`,`bookmarkId`,`originalLyrics`,`translatedLyrics`,`aiRomanized`,`aiTranslation`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      public SongLyricsEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new SongLyricsEntity(_tmpId,_tmpBookmarkId,_tmpOriginalLyrics,_tmpTranslatedLyrics,_tmpAiRomanized,_tmpAiTranslation);
          } else {
            _result = null;
          }
          return _result;
